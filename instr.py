...
txt_b1='Начать первый тест'
txt_b2='Начать делать приседания'
txt_b3='Начать финальный тест'
txt_b4='Отправить результаты'
txt_timer=''
...
txt_res3='средняяю Возмозжно, стоит дополнительно обседоваться у врача.'
